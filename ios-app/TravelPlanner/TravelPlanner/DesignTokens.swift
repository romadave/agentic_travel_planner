...
struct DesignTokens {
    ...
    struct Colors {
        ...
        // Chip / toggle pill colors
        static let chipSelectedBg = Color(red: 44/255, green: 44/255, blue: 44/255)
        static let chipSelectedFg = Color.white
        static let chipUnselectedBg = Color.white
        static let chipUnselectedFg = Color(red: 26/255, green: 26/255, blue: 26/255)
        static let chipBorder = Color(red: 212/255, green: 204/255, blue: 196/255)

        // Tip banner
        static let tipBg = Color(red: 240/255, green: 230/255, blue: 220/255)
        static let tipIcon = Color(red: 180/255, green: 110/255, blue: 80/255)

        // Stepper row icon circle
        static let avatarBg = Color(red: 232/255, green: 224/255, blue: 216/255)
        static let avatarFg = Color(red: 180/255, green: 110/255, blue: 80/255)

        // Progress bar
        static let progressFill = Color(red: 26/255, green: 26/255, blue: 26/255)
        static let progressTrack = Color(red: 232/255, green: 224/255, blue: 216/255)
    }
    ...
    struct Typography {
        ...
        static let headlineLG = Font.system(size: 30, weight: .regular, design: .serif)
        ...
        static let stepCounter = Font.system(size: 14, weight: .medium).monospacedDigit()
    }
